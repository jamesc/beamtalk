...
| Guide | Description |
|-------|-------------|
| [Deploying](deploying.md) | `beamtalk release`, the `bin/<name>` launcher, Docker/systemd examples, console + reverse proxy, upgrades (ADR 0125) |
...
3. **REPL-Protocol Tests** (`tests/repl-protocol/cases/*.btscript`)
