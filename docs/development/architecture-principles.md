 ...
 **Domain Driven Design:** [AGENTS.md - Domain Driven Design section](../../docs/agents/expanded.md)
 **Rust Best Practices:** [AGENTS.md - Rust Development Best Practices](../../docs/agents/expanded.md)
