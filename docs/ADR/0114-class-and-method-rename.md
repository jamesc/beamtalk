...
{ts, seq, epoch, class, selector: "<new selector>", old_selector: "<old selector>",
 ...
 sites: [{sourceFile, span: {start, end}, source_ref, prev_source_ref}, ...],
   ...
   %% that subclass tree also defines this selector (implementors_of/1
   %% intersected with the subclass closure; an override anywhere means
   %% self/super dispatch can be
