...
| [0125](0125-otp-releases-and-upgrade-compatibility.md) | OTP Releases and Upgrade Compatibility | Implemented | 2026-09-24 |
...
| [0129](0129-class-side-system-facades.md) | Replace Injected `Beamtalk`/`Workspace`/`Transcript` Bindings with Class-Side Facades | Proposed | 2026-09-25 |
