...
**Status:** In progress. BT-3343 and BT-3341 have landed; the rest are still Planned. Decision step 5 (the full bounded-context crate split) is explicitly out of scope for this epic — revisit once BT-3341/BT-3342 land and the ADR's dependency-graph extraction is re-run to confirm the cross-context cycles are gone.
