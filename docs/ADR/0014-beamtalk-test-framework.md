...
| Component | Location | Description |
|-----------|----------|-------------|
| TestCase class | `stdlib/src/test_case.bt` | Assertion methods, lifecycle hooks |
...
| TestResult class | `stdlib/src/test_result.bt` (optional) | Collect and report test results |
