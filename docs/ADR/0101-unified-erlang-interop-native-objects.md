...
- **Phase 4 — `internal` seams for embedded FFI.** Extract SystemNavigation's 29 (+ thin tail) into `internal` helpers. *Files:* `stdlib/src/system_navigation.bt` et al.
...
## References
- Related issues: BT-2719 (Epic) · BT-2720 · BT-2721 · BT-2722 · BT-2723 · BT-2724 · BT-2725 · BT-2726 · BT-2727 · BT-2730 (FFI error-details harmonization) · BT-2731 (remaining FFI Object classes — see Resolved Decision 5)
