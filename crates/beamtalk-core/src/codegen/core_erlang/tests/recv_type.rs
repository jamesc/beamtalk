...
use crate::semantic_analysis::type_checker::{FunctionSignature, NativeTypeRegistry, ParamType};
use crate::semantic_analysis::{AnalysisContext, InferredType, TypeProvenance, analyse_full};
...
fn codegen_with_full_analysis(src: &str) -> String {
    ...
    crate::codegen::core_erlang::generate_module(
        &module,
        crate::codegen::core_erlang::CodegenOptions::new("test").with_analysis(analysis),
    )
    .expect("codegen should succeed")
}
