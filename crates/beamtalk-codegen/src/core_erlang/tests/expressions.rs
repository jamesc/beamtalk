...
fn test_number_coercion_try_catch_compiles_through_erlc() {
    ...
    assert_compiles_through_erlc("coercion_try", &core_erlang);
}
...
";
    ...
    assert_compiles_through_erlc("test_module", core_erlang);
}
...
";
    ...
    assert_compiles_through_erlc("test_string", core_erlang);
}
