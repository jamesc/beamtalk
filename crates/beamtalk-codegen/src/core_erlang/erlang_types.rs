...
//!
//! ```
//! use beamtalk_codegen::core_erlang::erlang_types::ErlangAtom;
//!
...
//!
//! ```
//! use beamtalk_codegen::core_erlang::erlang_types::ErlangVar;
//!
...
//!
//! ```
//! use beamtalk_codegen::core_erlang::erlang_types::ModuleName;
//!
...
impl ErlangAtom {
    ...
    #[must_use]
    pub fn from_selector(selector: &beamtalk_core::ast::MessageSelector) -> Self {
...
mod tests {
    use super::*;
    use beamtalk_core::ast::{KeywordPart, MessageSelector};
