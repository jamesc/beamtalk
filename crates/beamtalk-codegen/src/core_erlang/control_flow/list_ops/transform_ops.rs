...
impl CoreErlangGenerator {
    ...
    pub(in crate::core_erlang) fn generate_list_count(
        &mut self,
        receiver: &Expression,
        body: &Expression,
    ...
    pub(in crate::core_erlang) fn generate_list_count_with_mutations(
        &mut self,
        receiver: &Expression,
        body: &Block,
    ) -> Result<Document<'static>> {
        ...
        let (body_doc, _) =
            self.generate_foldl_loop_body(body, &plan, &BodyKind::FoldlCount, &acc_state_var, 1)?;
        docs.push(body_doc);
        self.pop_scope();
    ...
    pub(in crate::core_erlang) fn generate_list_flat_map(
        &mut self,
        receiver: &Expression,
        body: &Expression,
    ) -> Result<Document<'static>> {
    ...
    #[allow(clippy::too_many_lines)]
    pub(in crate::core_erlang) fn generate_list_flat_map_with_mutations(
        &mut self,
        receiver: &Expression,
        body: &Block,
    ) -> Result<Document<'static>> {
    ...
    pub(in crate::core_erlang) fn generate_list_inject(
        &mut self,
        receiver: &Expression,
        initial: &Expression,
        body: &Expression,
    ...
    #[allow(clippy::too_many_lines)]
    pub(in crate::core_erlang) fn generate_list_inject_with_mutations(
        &mut self,
        receiver: &Expression,
        initial: &Expression,
        body: &Block,
        ...
        let (body_doc, _) =
            self.generate_foldl_loop_body(body, &plan, &BodyKind::FoldlInject, &acc_state_var, 1)?;
        docs.push(body_doc);
        self.pop_scope();
    ...
    pub(in crate::core_erlang) fn generate_list_take_while(
        &mut self,
        receiver: &Expression,
        body: &Expression,
    ) -> Result<Document<'static>> {
    ...
    #[allow(clippy::too_many_lines)]
    pub(in crate::core_erlang) fn generate_list_take_while_with_mutations(
        &mut self,
        receiver: &Expression,
        body: &Block,
    ) -> Result<Document<'static>> {
    ...
    pub(in crate::core_erlang) fn generate_list_drop_while(
        &mut self,
        receiver: &Expression,
        body: &Expression,
    ) -> Result<Document<'static>> {
    ...
    #[allow(clippy::too_many_lines)]
    pub(in crate::core_erlang) fn generate_list_drop_while_with_mutations(
        &mut self,
        receiver: &Expression,
        body: &Block,
    ) -> Result<Document<'static>> {
    ...
    pub(in crate::core_erlang) fn generate_list_partition(
        &mut self,
        receiver: &Expression,
        body: &Expression,
    ) -> Result<Document<'static>> {
    ...
    #[allow(clippy::too_many_lines)]
    pub(in crate::core_erlang) fn generate_list_partition_with_mutations(
        &mut self,
        receiver: &Expression,
        body: &Block,
    ) -> Result<Document<'static>> {
    ...
    pub(in crate::core_erlang) fn generate_list_group_by(
        &mut self,
        receiver: &Expression,
        body: &Expression,
    ) -> Result<Document<'static>> {
    ...
    #[allow(clippy::too_many_lines)]
    pub(in crate::core_erlang) fn generate_list_group_by_with_mutations(
        &mut self,
        receiver: &Expression,
        body: &Block,
    ) -> Result<Document<'static>> {
    ...
    pub(in crate::core_erlang) fn generate_list_sort(
        &mut self,
        receiver: &Expression,
        body: &Expression,
    ) -> Result<Document<'static>> {
