...
[unix]
ci: build lint test test-integration test-mcp test-e2e check-corpus check-surface-drift

[windows]
ci: build clippy fmt-check-rust test test-integration test-mcp test-e2e check-surface-drift
