...
-moduledoc """
IO capture for Beamtalk REPL evaluation.
...
-doc """
Stop capturing IO and return all captured output as a binary.
...
-doc """
After capture, forward all IO to the original group_leader.
...
-doc """
Handle a single IO protocol request.
