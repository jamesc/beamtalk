...
-moduledoc """
Class-loaded event pub/sub for workspace WebSocket push (BT-1020).
...
-doc """
Subscribe the calling process to class-loaded events.
...
-doc """
Notify all subscribers that a class was loaded.
