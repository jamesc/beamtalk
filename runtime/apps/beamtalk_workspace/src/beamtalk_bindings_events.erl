...
-moduledoc """
Bindings-changed event pub/sub for workspace WebSocket push.
...
-doc """
Subscribe the calling process to bindings-changed events.
...
-doc """
Notify all subscribers that bindings changed for a session.
