...
%%% @doc Session registry backed by a named ETS table.
%%%
...
%% @doc Create the session ETS table if it does not already exist.
...
%% @doc Resolve a session ID to a live PID, falling back to `Default`.
%%
