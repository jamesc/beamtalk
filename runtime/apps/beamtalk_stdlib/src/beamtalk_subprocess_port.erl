...
-doc "Strip trailing \\r from a line (normalises Windows \\r\\n → \\n).".
...
-doc """
Prepend Pending to Data then split on newlines.
...
-doc """
Coerce a Beamtalk Array (tagged map or plain list) to an Erlang list.
