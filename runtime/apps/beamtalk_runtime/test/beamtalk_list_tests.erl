...
at_out_of_bounds_test() ->
    ?assertError(
        #{
            '$beamtalk_class' := _,
            error := #beamtalk_error{kind = does_not_understand, class = 'List'}
        },
...
at_invalid_type_test() ->
    ?assertError(
        #{'$beamtalk_class' := _, error := #beamtalk_error{kind = type_error, class = 'List'}},
...
detect_non_function_test() ->
    ?assertError(
        #{
            '$beamtalk_class' := _,
            error := #beamtalk_error{kind = type_error, class = 'List', selector = 'detect:'}
        },
...
detect_if_none_non_function_test() ->
    ?assertError(
        #{
            '$beamtalk_class' := _,
            error := #beamtalk_error{kind = type_error, class = 'List', selector = 'detect:ifNone:'}
        },
...
do_non_function_test() ->
    ?assertError(
        #{
            '$beamtalk_class' := _,
            error := #beamtalk_error{kind = type_error, class = 'List', selector = 'do:'}
        },
...
reject_non_function_test() ->
    ?assertError(
        #{
            '$beamtalk_class' := _,
            error := #beamtalk_error{kind = type_error, class = 'List', selector = 'reject:'}
        },
...
zip_non_list_test() ->
    ?assertError(
        #{
            '$beamtalk_class' := _,
            error := #beamtalk_error{kind = type_error, class = 'List', selector = 'zip:'}
        },
...
group_by_non_function_test() ->
    ?assertError(
        #{
            '$beamtalk_class' := _,
            error := #beamtalk_error{kind = type_error, class = 'List', selector = 'groupBy:'}
        },
...
partition_non_function_test() ->
    ?assertError(
        #{
            '$beamtalk_class' := _,
            error := #beamtalk_error{kind = type_error, class = 'List', selector = 'partition:'}
        },
...
from_to_non_integer_start_test() ->
    ?assertError(
        #{
            '$beamtalk_class' := _,
            error := #beamtalk_error{kind = type_error, class = 'List', selector = 'from:to:'}
        },
    ...
    ?assertError(
        #{
            ...
            error := #beamtalk_error{
                kind = does_not_understand, class = 'List', selector = 'from:to:'
            }
        },
...
sort_with_non_list_test() ->
    ?assertError(
        #{
            '$beamtalk_class' := _,
            error := #beamtalk_error{kind = type_error, class = 'List', selector = 'sort:'}
        },
