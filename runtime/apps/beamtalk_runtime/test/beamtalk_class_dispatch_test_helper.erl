...
%%% @doc Test helper module for beamtalk_class_dispatch_tests (BT-1085).
%%%
...
%% @doc Zero-argument class method that returns a plain value.
%%
...
%% @doc Zero-argument class method that returns a class_var_result tuple.
%%
...
%% @doc One-argument keyword class method that echoes its argument.
%%
