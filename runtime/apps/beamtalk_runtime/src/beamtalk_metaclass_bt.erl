...
-moduledoc """
Minimal Metaclass bootstrap stub for ADR 0036 (Full Metaclass Tower Phase 1).
...
-doc """
Dispatch instance messages on Metaclass objects.
...
ADR 0036 Phase 1: Implements the 3 identity predicates that are
...
-doc """
Register the 'Metaclass' class in the class registry.
