...
%%% @doc ETS table owner for the beamtalk_class_module table.
%%%
...
%% @doc Ensure the class module ETS table exists (idempotent).
%%
...
%% @doc Record a class and its module name in the table.
%%
...
%% @doc Remove a class entry from the table.
%%
...
%% @doc Look up the module name for a class.
%%
