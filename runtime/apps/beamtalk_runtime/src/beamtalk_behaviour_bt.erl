...
-moduledoc """
Bootstrap stub for the 'Behaviour' class (ADR 0032 Phase 2, BT-734).
...
-doc """
Dispatch instance messages on Behaviour class objects.
...
-doc """
Check if Behaviour has an instance method (stub: always false).
...
-doc """
Register the 'Behaviour' class in the class registry.
