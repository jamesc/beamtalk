...
-moduledoc """
Erlang shim for the Tracing stdlib class (ADR 0069 Phase 3).
...
-doc """
Set application-level trace context (merges with existing).
...
-doc """
All captured trace events, newest first.
...
-doc """
Trace events with opts map filter, newest first.
...
-doc """
Export trace events to a JSON file with optional filters.
...
-doc """
Live process health for a specific actor.
...
-doc "Extract a pid from a beamtalk_object record, a raw pid, or a dead reference.".
...
-doc """
Call the trace store, ignoring errors if not running.
...
-doc """
Call the trace store, returning a default value if not running.
