...
-moduledoc """
Erlang simulations of Beamtalk's block state-threading patterns.
...
-doc """
Idiomatic Erlang: tail-recursive accumulator.
Equivalent to:
...
-doc """
Simulates what Beamtalk's timesRepeat: codegen produces.
...
-doc """
Idiomatic Erlang: lists:map with inline fun.
...
-doc """
Simulates Beamtalk's stateful block for collect:.
...
-doc """
Idiomatic Erlang: lists:foldl with inline fun.
...
-doc """
Simulates Beamtalk's stateful block for inject:into:.
...
-doc """
Simulates current codegen for pure inject:into: — goes through
...
-doc """
Current StateAcc fallback for nested list op with outer variable mutation.
...
-doc """
Idiomatic Erlang baseline for `do:` with a local mutation.
...
-doc """
Simulates `do:` with a local mutation using old StateAcc map approach.
...
-doc """
Simulates `collect:` with a local mutation (count) using StateAcc map approach.
...
-doc """
Simulates `inject:into:` with a local mutation (count) using StateAcc map approach.
